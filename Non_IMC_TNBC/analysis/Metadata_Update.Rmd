...
Meta_viz <- Meta %>% #filter(HER2_case == FALSE) %>% 
  select(TMANr,PID,n_samples,grade,pT_simple,pN_simple,pM_simple,OS_data, DFS_data, age_bin, tumor_size_cm, lehmann_subtype) 
...
pdf("~/Desktop/TNBC/Metadaten/Metadata_combined_HeatmapAnno.pdf",width=9,height = 5, onefile = FALSE)
sample_anno
dev.off()
```
