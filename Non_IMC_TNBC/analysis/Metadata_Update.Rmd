...
#4. Combined - ZTMA174, ZTMA249 and ZTMA21/26

### Load all metadata

```{r}
Meta_174 <- read_csv("/Users/lasmey/Desktop/TNBC/Metadaten/ZTMA174_TNBC_LM_processed.csv")
Meta_249 <- read_csv("/Users/lasmey/Desktop/TNBC/Metadaten/ZTMA249_TNBC_LM_processed.csv")
...
Meta_2126_comb <- Meta_2126 %>% select("TMANr","ID_Number","PID","n_samples","age","grade","pT","pT_simple","pN","pN_simple","pM","pM_simple","status_OS","OS_months", "status_DFS","DFS_months","OS_data","DFS_data","HER2_case") %>% mutate_all(as.character)
...
```{r save combined}
Meta <- read.csv("/Users/lasmey/Desktop/TNBC/Metadaten/Metadata_Combined_TNBC_LM.csv")
```
...
pdf("~/Desktop/TNBC/Metadaten/Metadata_combined_HeatmapAnno.pdf",width=12,height = 7, onefile = FALSE)
sample_anno
dev.off()
```
