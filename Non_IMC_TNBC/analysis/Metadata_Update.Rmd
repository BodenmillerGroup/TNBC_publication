...
PID174_HER2 <- read.csv("~/Desktop/BNummer_HER2_PS_174.csv")
...
age_249 <- read_csv("~/Desktop/BNummer_age249_PS.csv")
...
Meta_174_comb <- Meta_174 %>% select("TMANr","PID","n_samples","age","tumor_size_cm","grade","pT","pT_simple","pN","pN_simple","pM","pM_simple","status_OS","OS_months", "status_DFS","DFS_months","OS_data","DFS_data","HER2_case")

Meta_249$TMANr <- "TMA249"
Meta_249$HER2_case <- FALSE
Meta_249_comb <- Meta_249 %>% select("TMANr","ID_Number","PID","n_samples","age","lehmann_subtype","grade","pT","pT_simple","pN","pN_simple","pM","pM_simple","status_OS","OS_months", "status_DFS","DFS_months","OS_data","DFS_data","HER2_case")
...
#Filter for columns to visualize
Meta_viz <- Meta %>% filter(HER2_case == FALSE) %>% select(TMANr,PID,n_samples,grade,pT_simple,pN_simple,pM_simple,OS_data, DFS_data, age_bin, tumor_size_cm, lehmann_subtype) 
