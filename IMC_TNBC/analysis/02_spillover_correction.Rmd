...
sm_jana <- read.csv("/mnt/rcc_volume/TNBC/data_analysis/spillover_matrix_Jana.csv",row.names = 1)
...
```{r write_sm_csv}
sm
write.csv(sm, "/mnt/rcc_volume/TNBC/data_analysis/spillover_matrix_LM_mod.csv")

sm_jana
write.csv(sm, "/mnt/rcc_volume/TNBC/data_analysis/spillover_matrix_Jana_mod.csv")
```
...
sce <- readRDS("/mnt/rcc_volume/TNBC/data_analysis/sce_TNBC.rds")
...
```{r save, message = F}
saveRDS(sce, "/mnt/rcc_volume/TNBC/data_analysis/sce_TNBC_spillcor.rds")
