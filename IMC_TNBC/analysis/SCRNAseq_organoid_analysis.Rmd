...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_CK57score_Heatmap_Keratins.pdf",height = 4, width = 7, onefile = FALSE)
Heatmap(t(scaled_mat), name = "Scaled mean expression")+
  rowAnnotation(n = anno_barplot(anno$n, gp = gpar(fill = "#440154FF")))+
  rowAnnotation(anno = anno_text(anno$KRT5_7_score))
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_UMAP_Keratins.pdf",height = 10, width = 10, onefile = FALSE)
all_plots_UMAP_keratins
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_CK57score_Scatter.pdf",height = 4, width = 6, onefile = FALSE)
ggplot(cur_dat, aes(x=KRT7, y=KRT5, color = KRT5_7_score)) +
  geom_point(alpha = 0.5)+
  theme_classic()+
  xlab("KRT7 logcounts")+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_CK57score_PID_Barplot.pdf",height = 4, width = 7, onefile = FALSE)
dittoBarPlot(sce, var = "KRT5_7_score", group.by = "Patient_ID",scale="percent")+
    scale_fill_manual(values = metadata(sce)$colors$KRT57_score)
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_CK57score_Heatmap_Stem.pdf",height = 4, width = 9, onefile = FALSE)
Heatmap(t(scaled_mat), name = "Scaled mean expression")+
  rowAnnotation(n = anno_barplot(anno$n, gp = gpar(fill = "#440154FF")))+
  rowAnnotation(anno = anno_text(anno$KRT5_7_score))
dev.off()
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_CK57score_PanAV_Boxplot.pdf",height = 5, width = 5, onefile = FALSE)
ggplot(plot_df, aes(x = cat, y = signature_score))+
  geom_boxplot(outlier.color = NA)+
  geom_jitter(aes(color = cat), size = 3, position=position_jitter(w=0.1,h=0.1))+
  scale_color_manual(values = metadata(sce)$colors$KRT57_score)+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_CK57score_BLSignature_Boxplot.pdf",height = 5, width = 5, onefile = FALSE)
ggplot(plot_df, aes(x = cat, y = signature_score))+
  geom_boxplot(outlier.color = NA)+
  geom_jitter(aes(color = cat), size = 3, position=position_jitter(w=0.1,h=0.1))+
  scale_color_manual(values = metadata(sce)$colors$KRT57_score)+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_CK57score_BLSignature_Heaptmap.pdf",height = 4, width = 9, onefile = FALSE)
Heatmap(test_plot, name = "Expression")
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/scRNA_organoid/Organoid_scRNA_CK57score_LumProgenitorLIM_Boxplot.pdf",height = 5, width = 5, onefile = FALSE)
ggplot(plot_df, aes(x = cat, y = signature_score))+
  geom_boxplot(outlier.color = NA)+
  geom_jitter(aes(color = cat), size = 3, position=position_jitter(w=0.1,h=0.1))+
  scale_color_manual(values = metadata(sce)$colors$KRT57_score)+
