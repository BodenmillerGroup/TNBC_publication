...
ggsurvplot(fit,
          ...
          palette = c("grey","orange","firebrick","green4"),
          log.rank.weights = "n", 
          xlim = c(0, 4000))
...
## Keratin expression comparison for PID groups 
...
## Stem-like marker expression comparison for PID groups 
...
## Lim et al signatures for PID groups 
