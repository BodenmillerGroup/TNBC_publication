...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_HLADRGMM.pdf", height = 4, width = 7, onefile = FALSE)
ggplot(GMM_df, aes(x = HLADR_exprs))+
  geom_density()+
  geom_rug(aes(color = class_epi))+
  theme_classic(base_size = 15)+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_Alluvial.pdf", height = 5, width = 5, onefile = FALSE)
alluvial_wide(df_alluvial, 
              colorful_fill_variable_stratum = FALSE,
              col_vector_flow = metadata(vsd)$colors$KRT57_score, 
              order_levels = c("KRT5/7-","KRT7+","KRT5+","KRT5/7+"))+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_Marker.pdf", height = 5, width = 3, onefile = FALSE)
Heatmap(scale(t(assay(GOI_mean_sce, "vst"))))
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_Marker_Immune.pdf", height = 4, width = 7, onefile = FALSE)
Heatmap(scale(t(assay(GOI_mean_sce, "vst"))))+
  Heatmap(scale(t(assay(GOI_mean_sce_2, "vst"))))
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_Kaplan_DFS.pdf", height = 7, width = 6, onefile = FALSE)
ggsurvplot(fit,
          pval = TRUE,
          risk.table = TRUE, # Add risk table
          risk.table.col = "strata", # Change risk table color by groups
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_Kaplan_PFS.pdf", height = 7, width = 6, onefile = FALSE)
ggsurvplot(fit_1,
          pval = TRUE,
          risk.table = TRUE, # Add risk table
          risk.table.col = "strata", # Change risk table color by groups
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_Kaplan_DFS_TNBC.pdf", height = 7, width = 6, onefile = FALSE)
ggsurvplot(fit,
          pval = TRUE,
          risk.table = TRUE, # Add risk table
          risk.table.col = "strata", # Change risk table color by groups
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_Kaplan_PFS_TNBC.pdf", height = 7, width = 6, onefile = FALSE)
ggsurvplot(fit_1,
          pval = TRUE,
          risk.table = TRUE, # Add risk table
          risk.table.col = "strata", # Change risk table color by groups
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_CoxDFS_Multi.pdf",width = 7,height = 5, onefile = FALSE)
hr_prop
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_CoxDFS_Uni.pdf",width = 5,height = 5, onefile = FALSE)
hr_prop
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_PAM50_Bar.pdf",width = 5,height = 4, onefile = FALSE)
dittoBarPlot(vsd, var = "PID_group_test", group.by = "PAM50Call_RNAseq",retain.factor.levels = TRUE)+
  scale_fill_manual(values = group_color)+
  ggtitle("")
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_PIDgroups_TNBC_Bar.pdf",width = 4,height = 4, onefile = FALSE)
dittoBarPlot(vsd, var = "PID_group_test", group.by = "TNBC",retain.factor.levels = TRUE)+
  scale_fill_manual(values = group_color)+
  ggtitle("")
dev.off()
