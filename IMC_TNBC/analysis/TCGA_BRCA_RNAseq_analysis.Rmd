...
## 7. Li et al signatures for PID groups 
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_CK57score_Heatmap_Keratins.pdf", height = 4, width = 6, onefile = FALSE)
Heatmap(scale(ht), name = "Scaled mean Z-scores")
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TCGA_BRCA/TCGA_BRCA_CK57score_Heatmap_Stem.pdf", height = 4, width = 8, onefile = FALSE)
Heatmap(scale(ht), name = "Scaled mean Z-scores")
dev.off()
