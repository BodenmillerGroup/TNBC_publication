...
Perform DEA based on combined score 
...
```{r}
#Save objects 
saveRDS(res, "/mnt/rcc_volume/TNBC/data_analysis/TCGA_BRCA_DESeq_VST_full_DiffResults.rds")
saveRDS(vsd, "/mnt/rcc_volume/TNBC/data_analysis/TCGA_BRCA_DESeq_VST_full_DiffResults_VST.rds")
