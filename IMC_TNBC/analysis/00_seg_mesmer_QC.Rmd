...
```{r read-images}
#images <- loadImages("/Volumes/rcc_volume/TNBC/img/",on_disk = TRUE,h5FilesPath = "/Volumes/rcc_volume/TNBC/img_h5/")
...
panel <- read_csv("/Volumes/rcc_volume/TNBC/panel.csv")
channelNames(images) <- panel$clean_target
images

#Load masks
#masks_1 <- loadImages("/Volumes/rcc_volume/TNBC/masks_1/", as.is = TRUE)
#masks_2 <- loadImages("/Volumes/rcc_volume/TNBC/masks_2/", as.is = TRUE)
#masks_3 <- loadImages("/Volumes/rcc_volume/TNBC/masks_3/", as.is = TRUE)
#masks_4 <- loadImages("/Volumes/rcc_volume/TNBC/masks_4/", as.is = TRUE)
#masks_5 <- loadImages("/Volumes/rcc_volume/TNBC/masks_5/", as.is = TRUE)

masks_1 <- readRDS("/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_1.rds")
masks_2 <- readRDS("/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_2.rds")
masks_3 <- readRDS("/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_3.rds")
masks_4 <- readRDS("/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_4.rds")
masks_5 <- readRDS("/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_5.rds")
```
...
PID <- paste0("ID_",str_split(names(images), "_",simplify = TRUE)[,4])

mcols(images) <- mcols(masks_1) <- mcols(masks_2) <- mcols(masks_3) <- mcols(masks_4) <- mcols(masks_5) <- DataFrame(sample_id = names(images),
                                           PID = PID)
```
...
#saveRDS(images, "/Volumes/rcc_volume/TNBC/data_analysis/images_segtest.rds")

#saveRDS(masks_1, "/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_1.rds")
#saveRDS(masks_2, "/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_2.rds")
#saveRDS(masks_3, "/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_3.rds")
#saveRDS(masks_4, "/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_4.rds")
#saveRDS(masks_5, "/Volumes/rcc_volume/TNBC/data_analysis/masks_segtest_5.rds")
...
img_files <- list.files("/Volumes/rcc_volume/TNBC/img/")
...
sce_4 <- read_steinbock("/Volumes/rcc_volume/TNBC/",intensities_folder = "intensities_4",return_as = "sce",regionprops_folder = NULL,graphs_folder = NULL)

sce_5 <- read_steinbock("/Volumes/rcc_volume/TNBC/",intensities_folder = "intensities_5",return_as = "sce",regionprops_folder = NULL,graphs_folder = NULL)
