...
```{r read-images}
#images <- loadImages("/mnt/rcc_volume/TNBC/img/",on_disk = FALSE,BPPARAM = MulticoreParam(workers = 2,progressbar = TRUE,stop.on.error = FALSE))
#images <- loadImages("/mnt/rcc_volume/TNBC/img/",on_disk = TRUE,h5FilesPath = "/mnt/rcc_volume/TNBC/h5_img/",BPPARAM = MulticoreParam(workers = 14,progressbar = TRUE))
...
panel <- read_csv("/mnt/rcc_volume/TNBC/panel.csv")
channelNames(images) <- panel$clean_target
images

#Load masks
#masks_1 <- loadImages("/mnt/rcc_volume/TNBC/masks_1/", as.is = TRUE)
#masks_2 <- loadImages("/mnt/rcc_volume/TNBC/masks_2/", as.is = TRUE)
#masks_3 <- loadImages("/mnt/rcc_volume/TNBC/masks_3/", as.is = TRUE)
#masks_4 <- loadImages("/mnt/rcc_volume/TNBC/masks_4/", as.is = TRUE)
#masks_5 <- loadImages("/mnt/rcc_volume/TNBC/masks_5/", as.is = TRUE)

masks_1 <- readRDS("/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_1.rds")
masks_2 <- readRDS("/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_2.rds")
masks_3 <- readRDS("/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_3.rds")
masks_4 <- readRDS("/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_4.rds")
masks_5 <- readRDS("/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_5.rds")
```
...
saveRDS(images, "/mnt/rcc_volume/TNBC/data_analysis/images_segtest.rds")

saveRDS(masks_1, "/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_1.rds")
saveRDS(masks_2, "/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_2.rds")
saveRDS(masks_3, "/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_3.rds")
saveRDS(masks_4, "/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_4.rds")
saveRDS(masks_5, "/mnt/rcc_volume/TNBC/data_analysis/masks_segtest_5.rds")
```
