...
pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_EcadpanCKCor.pdf")
pairs.panels(cor_sce,
             method = "spearman",
             hist.col = "#A6CEE3",
             digits = 2)
...
pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_GMMpanCK.pdf", width = 5)
GMM_plot_exp/GMM_plot_unc
dev.off()

pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_GMMEcad.pdf",width = 5)
GMM_plot_exp_1/GMM_plot_unc_1
dev.off()

pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_EpiNonEpi_HeatmapGMMCC.pdf",width = 15,height = 10)
draw(h)
dev.off()

pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_EpiNonEpi_DensityCC.pdf", width = 5, height = 5)
ggplot(anno_cluscat, aes(fr_tum))+
  geom_density(size = 1)+
  geom_rug(aes(color = cluster_category))+
...
pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_AlluvialGMMCC.pdf",width = 8,height = 5)
alluvial_wide(data = colData(sce) %>% as.data.frame %>% select(cluster_category, analysis_cat), 
              max_variables = 4,
              fill_by = 'all_flows',
              order_levels = c("Non_Epithelial","Epithelial","Mixed","tumor","non_tumor"))+
...
pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_UpsetCC_TUMOR.pdf")
upset
dev.off()

pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_UpsetCC_TME.pdf")
upset_1
dev.off()

pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_TSNE_collection.pdf", width = 12)
p1+p2+p3+p4+p5+p6
dev.off()

pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/04_initial_clus/TNBC_TSNE_exprsmarkers.pdf", height = 20, width = 12)
plots_TSNE_exp
dev.off()
