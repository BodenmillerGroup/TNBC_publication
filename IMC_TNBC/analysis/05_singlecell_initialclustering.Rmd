...
## Add metadata for ZTMA249 

```{r metadata, message =FALSE}
#Add PID to sce object
sample_meta <- read.csv("/mnt/rcc_volume/TNBC/data_analysis/03_data/ZTMA249_metadata_processed.csv")
sce$ID <- str_split(sce$sample_id,"_",simplify = TRUE)[,4]

#Add PID and lehmann_subtype
sce$PID <- sample_meta$PID[match(sce$ID,sample_meta$ID_Number)]
```
