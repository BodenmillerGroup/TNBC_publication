...
sce_sub <- sce[,sce$cluster_50_renamed %in% c("11","6","9","10")]
sce_sub
...
plotPixels(cur_images,
           ...
           save_plot = list(filename = paste0("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TME_clusters_viz/TME_pixel_cluster_TBMacroCells.png"), scale = 2)
           )
