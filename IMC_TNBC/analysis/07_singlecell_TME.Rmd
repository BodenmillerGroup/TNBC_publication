...
cluster_channel = c("Vimentin","SMA","Fibronectin","CD68","CD3","CD20","CD11c","CD45","CD20","CD8a","CD4","CD31_vWF","CD15","GATA3")

other_epi_channel = c("panCK","Ecad","CK5","CK8_18","KRT14","cMYC","HER2","ER","PR","p53","AR","EGFR","p_mTOR","CK7")
...
col_anno <- anno %>% filter(!cluster_100 %in% c("26","23"))
...
#kmeans clustering
#set.seed(22)
#out_k <- kmeans(PID_clr,centers = 14,nstart = 10000,iter.max = 10000)
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/TNBC_249_TME_CC_Silhouette_Cluster100.pdf",width = 12,height = 10)
p4
dev.off()
