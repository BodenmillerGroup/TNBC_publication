...
saveRDS(sce, "/mnt/tnbc_volume/TNBC_all/data_analysis/06_sce_TNBC_TME_com.rds")
...
#sce <- readRDS("/mnt/tnbc_volume/TNBC_all/data_analysis/06_sce_TNBC_TME.rds")
#sce
...
write.csv(expr_astir, file = "/mnt/tnbc_volume/TNBC_all/data_analysis/04_astir/expr_TNBC_TME_astir.csv",row.names = TRUE)

### RUN ASTIR IN CONDA_ENVIRONMENT ###

# Import Astir results 

astir_type <- read_csv("/mnt/tnbc_volume/TNBC_all/data_analysis/04_astir/cell_types_TNBC_TME.csv",col_names = c("ID","cell_type"),skip = 1)
...
#Save subsampled sce
#saveRDS(sce_sub,"/mnt/tnbc_volume/TNBC_all/data_analysis/sce_sub_TNBC_249_TME_CC_ClusterChannelClus_k.rds")
```
...
SID_immune_metacluster_cor_plot <- ggplot(SID_immune_metacluster_cor, aes(x = category, y = V1))+
  ...
  ggtitle(paste("Spearman rho = ",round(median(SID_immune_metacluster_cor$V1, na.rm = TRUE), digits = 3)))
...
SID_immune_metacluster %>% filter(immune_metacluster == "BnT_cell") %>% arrange(desc(density))
...
plotPixels(cur_images,
           ...
           save_plot = list(filename = paste0("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/TME_clusters_viz/TME_viz_cluster_",i,".png"), scale = 2)
           )
...
pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_ClusterTesting.pdf",width = 10,height = 5)
p1+p2+p3
dev.off()

pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_Silhouette_Cluster50.pdf",width = 12,height = 10)
p4
dev.off()

pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/06_TME/TNBC_249_TME_CC_HeatmapCluster.pdf",width = 13,height = 7)
h
dev.off()

pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_HeatmapCluster_Scales.pdf",width = 13,height = 8)
h_exprs + h_min_max
dev.off()

pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_ClusterAnno.pdf",width = 5,height = 8)
h_cluster_anno
dev.off()
...
pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_ExpressionCor.pdf",width = 10,height = 8)
corrplot(cor(cor_sce,method = "spearman"), method="color", col=brewer.pal(n=8, name="RdBu"),  
         type="upper", order="hclust",hclust.method = "ward.D2", 
         addCoef.col = "black", addCoefasPercent = F,# Add coefficient of correlation
         tl.col="black", tl.srt=40, #Text label color and rotation
...
pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_TSNECluster.pdf",width = 8,height = 6)
TSNE_clus
dev.off()

pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_TSNEExpression.pdf",width = 12,height = 6)
exp_plots_TSNE
dev.off()

pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_UMAPExpression.pdf",width = 12,height = 6)
exp_plots_UMAP
dev.off()

pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_ClusterPIDSID.pdf",width = 12,height = 6)
p_clusterPID
dev.off()

pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_PIDCluster_ClusterCor.pdf",width = 14,height = 6)
...
pdf("/mnt/tnbc_volume/TNBC_all/data_analysis/01_figures/07_TME/TNBC_249_TME_CC_Cluster_HR_DFS.pdf",width = 8,height = 10)
hr_prop/
hr_cat/
hr_cat_GMM
dev.off()
