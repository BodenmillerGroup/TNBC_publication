...
#based on cluster categories (n=430840)
...
cluster_channel = c("Vimentin","SMA","Fibronectin","CD68","CD3","CD20","CD11c","CD20","CD8a","CD4","CD31_vWF","CD15")

other_epi_channel = c("panCK","Ecad","CK5","CK8_18","KRT14","cMYC","HER2","ER","PR","p53","AR","EGFR","p_mTOR","CK7","GATA3","CD45")
...
clusters <- clusters[!clusters %in% c("cluster_50_renamed","cluster_50_merg")]
