...
sce <- readRDS("/mnt/rcc_volume/TNBC/data_analysis/06_sce_TNBC_TME_new.rds")
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/06_TME/TNBC_TME_Heatmap_ClusterTesting.pdf",height = 4, width = 9)
p1+p2+p3 
dev.off()
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/06_TME/TNBC_TME_CC_HeatmapCluster.pdf",width = 11,height = 7)
draw(h,annotation_legend_list = list(lgd_astir, lgd_meta))
dev.off()
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/06_TME/TNBC_TME_FractionHeatmap.pdf", width = 8, height = 18, onefile = FALSE)
fraction_anno + NULL
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/06_TME/TNBC_TME_Metacluster_Fra_Cor.pdf", width = 6)
SID_immune_metacluster_cor_plot
dev.off()


pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/06_TME/TNBC_TME_clrDR_MetaclusterPID.pdf", height = 5, width = 6)
clrDR(sce_cat, dr = "PCA", 
      by = "cluster_id", k = "immune_metacluster", 
      label_by = "cluster_id", arrow_col = "PID", 
      point_pal = metadata(sce_cat)$colors$immune_metacluster, 
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/06_TME/TNBC_TME_clrDR_PIDMetacluster.pdf", height = 5, width = 6)
clrDR(sce_cat, dr = "PCA", 
      by = "sample_id", point_col = "sample_id",
      k = "immune_metacluster", point_pal = metadata(sce_cat)$colors$PID)+
  scale_color_manual(values = metadata(sce_cat)$colors$immune_metacluster)+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/06_TME/TNBC_TME_Cox_HR_DFS_Meta_Multi.pdf", height = 4, width = 8)
hr_prop
dev.off()
