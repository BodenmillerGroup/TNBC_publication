...
pdf("/mnt/central_nas/tnbc_volume/TNBC/data_analysis/01_figures/HER2exprs_TMAs.pdf",width = 8,height = 6)
p2
dev.off()

## remove HER2 positive cases
## kick out 1 case with suspiciously high HER2 expression
