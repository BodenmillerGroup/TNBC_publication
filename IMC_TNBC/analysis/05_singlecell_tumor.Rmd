...
pretreatment_mc <- colData(sce) %>% as.data.frame() %>% select(metacluster,pretreatment) %>% group_by(metacluster) %>% table() %>% as.data.frame
...
pretreatment_CK57 <- colData(sce) %>% as.data.frame() %>% select(CK5_7_group,pretreatment) %>% group_by(CK5_7_group) %>% table() %>% as.data.frame
