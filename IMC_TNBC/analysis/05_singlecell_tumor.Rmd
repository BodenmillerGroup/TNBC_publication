...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Heatmap_ClusterTesting.pdf",height = 4, width = 9)
p1+p2+p3 
dev.off()
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Heatmap_Cluster_Metacluster_QC.pdf",width = 14,height = 9)
draw(h_meta)
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Metacluster_Fra_Cor.pdf", height = 8)
SID_metacluster_cor_plot
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_CLRDR_Metacluster.pdf")
clrDR(sce_cat, dr = "PCA", 
      by = "cluster_id", k = "metacluster", 
      label_by = "cluster_id", arrow_col = "PID", 
      point_pal = metadata(sce_cat)$colors$metacluster, 
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_FractionHeatmap.pdf", width = 10, height = 16, onefile = FALSE)
fraction_anno + NULL
dev.off()


pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_EucDistanceCLR_Fra.pdf", height = 6,width = 9)
ggplot(out_plot_1, aes(x = dist))+
  geom_density(aes(fill = category), color = "black",alpha = 0.5)+
  #geom_rug(aes(color = PID))+
  geom_rug(aes(color = category), alpha = 0.5)+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_DominantBar.pdf", width = 5)
ggplot(out_bar, aes(x = category, y = n, fill = dominant))+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Dominant_Scatter.pdf", height = 6, width = 9)
ggplot(test_plot, aes(mean_fra, dif_fra, color = PID))+
  geom_point(size = 3)+
  coord_cartesian(xlim = c(0,1), ylim = c(0,1))+
  scale_color_manual(values = metadata(sce)$colors$PID)+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Cox_HR_DFS.pdf", height = 4, width = 8)
ggplot(plot_df_prop, aes(x = reorder(group,desc(HR)), y = HR, color = p_value < 0.05))+
geom_point(size = 4)+
geom_errorbar(aes(ymax = CI_high, ymin = CI_low))+
#coord_cartesian(ylim=c(0,50))+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Kaplan_DFS_bestcutoff.pdf", width = 6, height = 6, onefile = FALSE)
ggsurvplot(fit,
          pval = TRUE,
          risk.table = TRUE, # Add risk table
          risk.table.col = "strata", # Change risk table color by groups
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_DiffAbun_Node.pdf", width = 8, height = 5, onefile = FALSE)
ggplot(DA, aes(x = logFC, y = logCPM))+
  geom_point(aes(col= cluster, 
                 size = -log10(FDR)))+
  geom_label_repel(data = DA %>% filter(FDR<0.1), aes(label = cluster))+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_CK57score_Heatmap.pdf", width = 11, onefile = FALSE)
h
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_CK57score_Cox.pdf",width = 8,height = 4)
ggplot(plot_df_prop, aes(x = reorder(group,desc(HR)), y = HR, color = p_value < 0.05))+
geom_point(size = 4)+
geom_errorbar(aes(ymax = CI_high, ymin = CI_low))+
#coord_cartesian(ylim=c(0,50))+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Cluster_Fra_Cor.pdf", height = 8)
SID_cluster_cor_plot
dev.off()


pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_CLRDR_PID.pdf")
clrDR(sce_cat, dr = "PCA", 
      by = "sample_id", point_col = "sample_id",
      k = "metacluster", point_pal = metadata(sce_cat)$colors$PID)+
  scale_color_manual(values = metadata(sce_cat)$colors$metacluster)+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_n_metacluster_PID.pdf", height = 8)
n_MC_PID
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_n_cluster_PID.pdf", height = 8)
n_clus_PID
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_DominantBar_Clus.pdf", width = 5)
ggplot(out_bar, aes(x = category, y = n, fill = dominant))+
  geom_tile(position = "stack", color = "black",alpha = 0.5)+
  theme_classic()+
  ylab("Number of PID")+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Basoluminal_Scatter.pdf", height = 4,width = 8)
scatter_CK5_7 + scatter_CK5_8_18
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Cox_HR_OS_Meta.pdf", height = 4, width = 8)
ggplot(plot_df_prop, aes(x = reorder(group,desc(HR)), y = HR, color = p_value < 0.05))+
geom_point(size = 4)+
geom_errorbar(aes(ymax = CI_high, ymin = CI_low))+
#coord_cartesian(ylim=c(0,50))+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Cox_HR_DFS_Meta_Uni.pdf", height = 4, width = 6)
hr_prop
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Cox_HR_DFS_CK57PID_Uni.pdf", height = 4, width = 4)
hr_prop
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Cox_HR_DFS_Clus_Lasso.pdf", height = 5, width = 8)
lasso_plot
dev.off()

pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_KaplanMeier_pNmerg.pdf", width = 6, height = 6, onefile = FALSE)
ggsurvplot(fit,
          pval = TRUE,
          risk.table = TRUE, # Add risk table
          risk.table.col = "strata", # Change risk table color by groups
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_DiffAbun_Node_Clus.pdf", width = 6, height = 5, onefile = FALSE)
ggplot(DA, aes(x = logFC, y = logCPM))+
  geom_point(aes(col= cluster, 
                 size = -log10(FDR)))+
  geom_label_repel(data = DA %>% filter(FDR<0.05), aes(label = cluster))+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_CK57score_scater.pdf", width = 5, height = 5)
ggplot(cur_dat, aes(x=CK7, y=CK5, color = CK5_7_score)) +
  geom_point(alpha = 0.5)+
  theme_classic()+
  xlab("CK7 exprs")+
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Age_MC8Abundance_scater.pdf", width = 5, height = 5)
ggplot(PID_MC8, aes(x = fra, y=age))+
  geom_point()+
  stat_smooth(method = "lm",
              formula = y ~ x,
...
pdf("/mnt/rcc_volume/TNBC/data_analysis/01_figures/05_tumor/TNBC_Tumor_Age_CK57pos_scater.pdf", width = 5, height = 5)
ggplot(PID_CK57_pos, aes(x = fra, y=age))+
  geom_point()+
  stat_smooth(method = "lm",
              formula = y ~ x,
