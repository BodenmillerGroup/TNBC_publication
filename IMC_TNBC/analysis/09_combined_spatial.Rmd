...
set.seed(22)
cur_sam <- sample(unique(sce$sample_id),20)
...
edges <- buildEdgeList(sce, combined = FALSE)
...
plotSpatialContextGraph(edges = edges, 
                        object = sce, 
                        img_id = "sample_id",
...
#spatial context abundance filter criteria - where to add?? 
