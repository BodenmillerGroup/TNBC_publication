...
sce <- read_steinbock("/Volumes/rcc_volume/TNBC/",intensities_folder = "intensities_4",return_as = "sce")

dim(assay(sce,"counts"))
sce
colData(sce)
length(unique(colData(sce)$sample_id))
```
...
saveRDS(sce, "/Volumes/rcc_volume/TNBC/data_analysis/sce_TNBC.rds")
```
