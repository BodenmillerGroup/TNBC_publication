...
plotCells(mask = masks[img_ids[1:9]], object = sce,
           img_id = "sample_id", cell_id = "ObjectNumber", colour_by = "cluster_combined",colour = col_clusters,outline_by = "cluster_origin")
